...
export function receivePuppies(data){
...
export const fetchPuppies = () => (dispatch) =>{
  ...
  fetch(puppiesUrl, { headers })
  	...
  	.catch(err => {
  		// Should probably dispatch an action to receive error instead 
...
export default { createPuppy, adoptPuppy, updateFilter, requestPuppies, receivePuppies, fetchPuppies }